...
<html lang="en">
  ...
  <body>
    ...
    <div class="edit-login">
        ...
        <hr>
        <form action="config/login_user.php" method="POST" onSubmit="validasi()">
          ...
          <div>
            ...
            <input type="password" class="form-control" cols="40" rows="5" name="password" id="password" required/>
          </div>
          <div>
          <button type="submit" class="btn btn-outline-primary my-2 my-sm-0"  role="button">Login</button>

          </div>
            <button type="reset" class="btn btn-outline-primary my-2 my-sm-0">Reset</button>
           </form>
        <a class="nav-link" href="Register.php">Belum Mempunyai Akun?</a>
    </div>
    <!--Akhir From Login-->
