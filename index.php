...
<html lang="en">
  ...
  <body>
      ...
      <header>
          <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="#"><b>WebLearning</b></a>
      ...
      <!-- Awal Banner/Header Terbuat Dari Boostrap 4 -->
      ...
      <!-- Akhir Banner/Header Terbuat Dari Boostrap 4 -->
       ...
       <div>
        ...
        <h6 class="card-title text-info">Pemrograman Web</h6>
...
<div>
       <!-- Akhir Konten Terbuat Dari Boostrap 4-->
